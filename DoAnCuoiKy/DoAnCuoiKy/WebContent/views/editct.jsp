...
<p style="margin-left: 30px; padding: 0; color: green">${message}</p>
		...
		<form class="form-add-content" id="addcontent" name="formcontent"
			...
			action="EditCt" method="post">

			<p class="header">Content Form Elements</p>

			<div class="row-form">
				<input type="hidden" name="id" value="<c:out value='${id}' />" /> <label
					for="title">Title</label> <input type="text" class="textbox"
					id="title" name="title" autocomplete="off"
					placeholder="Enter the title" value="${title}" maxlength="200">
			...
			<div class="row-form">
				...
				<textarea name="brief" id="brief" rows="3" class="textbox"
					autocomplete="off" maxlength="150">${brief}</textarea>
			...
			<div class="row-form">
				...
				<textarea name="content" id="content" rows="9" class="textbox"
					autocomplete="off" maxlength="1000">${content}</textarea>
